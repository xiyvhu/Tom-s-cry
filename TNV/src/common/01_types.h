...
#define OK            0//成功
#define ERROR        -1//失败
#define SOCKET_ERROR -2//套接字错误
#define STATUS_ERROR -3//服务器状态异常

//缓存
#define TRACKER_REDIS_RPEFIX "tracker"//跟踪服务器Redis前缀
#define STORAGE_REDIS_RPEFIX "storage"//存储服务器Redis前缀

//存储服务器状态
typedef enum stirage_status{
...
typedef struct storage_join{
	...
	char 	  si_groupname[STORAGE_GROUPNAME_MAX + 1];//组名
